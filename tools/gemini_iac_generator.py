...
- Do NOT wrap in code blocks"""
    ...
    outputs_prompt = """You are a senior Terraform engineer. Generate an outputs.tf file.
...
- storage_account_primary_connection_string (MUST mark as sensitive = true)

MANDATORY RULES:
- Include description for each output
- Mark connection string as sensitive = true
...
- Do NOT wrap in code blocks"""
    ...
    print("Security features enforced: TLS1.2, HTTPS-only, no public access, encryption, versioning")
